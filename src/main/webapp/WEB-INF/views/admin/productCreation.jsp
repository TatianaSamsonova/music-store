    ...
    <div class="container-wrapper">
        <div class="container">
            <div class="page-header">
                ...
                <p class="lead">The page for product creation</p>
            </div>
            ...
            <table class="table table-striped table-hover">
                ...
                <c:forEach items="${products}" var="product">
                    <tr>
                        ...
                        <td>
                            <a href="<c:url value="/music-store/admin/delete/${product.id}"/>">
                            <span>
            ...
            <a href="<spring:url value="product/add"/>" class="btn btn-secondary">Add product</a>
